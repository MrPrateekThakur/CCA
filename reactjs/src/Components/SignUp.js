...
//     //     // setFormData({ ...formData, image: profile.picture });

//     //     if (profile)
//     //         setFormData({ ...formData, first_name: profile.given_name, last_name: profile.family_name, image: profile.picture });

//     //     if (!profile)
//     //         setFormData({ ...formData, image: 'https://img.freepik.com/free-vector/businessman-character-avatar-isolated_24877-60111.jpg?w=740&t=st=1714302356~exp=1714302956~hmac=fd9dff0844f6c6523ff9d44704f7708e403b18006e19a90d0c407bf9c61a2483' });

//     //     console.log('After submit', formData);
//     //     handleAlert('success', 'Successfully');
//     //     axios.post(url.player.signup, formData)
//     //         .then(response => {
...
//         try {
//             const response = await axios.post(url.player.signup, formData);
//             console.log('After signUp', response.data.data);
//             handleAlert('success', 'Successfully');
//             navigate(-1);
...
//                                                 <input type="email" onChange={(e) => handleChange(e)} name='email' value={profile && profile.email} className="form-control form-control-md"
//                                                     placeholder="Enter a valid email address" />
//                                             </div>
//                                             <div className="form-outline">
//                                                 <label className="form-label" htmlFor="form3Example4">Password</label>
//                                                 <input onChange={(e) => handleChange(e)} type="password" name='password' value={formData.password} className="form-control form-control-md"
...
//                                                 <select className="form-select" name='user' value={formData.user} aria-label="Default select example">
...
//                                                 <input onChange={(e) => handleChange(e)} value={profile.given_name || formData.first_name} name='first_name' type="text" className="form-control form-control-md"
//                                                     placeholder="Enter your first name" />
//                                             </div>
//                                             <div className="form-outline mt-2">
//                                                 <label className="form-label">Last Name</label>
//                                                 <input onChange={(e) => handleChange(e)} value={profile.family_name || formData.first_name} name='last_name' type="text" className="form-control form-control-md"
//                                                     placeholder="Enter your last name" />
//                                             </div>
//                                             <div className="form-outline">
//                                                 <label className="form-label">Age</label>
//                                                 <input onChange={(e) => handleChange(e)} value={formData.age} name='age' type="text" className="form-control form-control-md"
//                                                     placeholder="Enter your age" />
//                                             </div>
//                                             <div className="form-outline">
//                                                 <label className="form-label">Gender</label>
//                                                 <select className="form-select" value={formData.gender} onClick={(e) => handleChange(e)} name='gender' aria-label="Default select example">
//                                                     <option style={{ color: '#000000' }} selected>Select Gender</option>
//                                                     <option style={{ color: '#000000' }} value="m">Male</option>
//                                                     <option style={{ color: '#000000' }} value="f">Female</option>
//                                                 </select>
//                                             </div>
//                                             <div className="form-outline mt-2">
//                                                 <label className="form-label">Mobile No.</label>
//                                                 <input type="text" onChange={(e) => handleChange(e)} value={formData.mobile} name='mobile' className="form-control form-control-md"
...
//                                                 <input onChange={(e) => handleChange(e)} value={formData.height} name='height' type="number" className="form-control form-control-md"
//                                                     placeholder="Enter your height" />
//                                             </div>
//                                             <div className="form-outline" data-mdb-input-init>
//                                                 <label className="form-label" htmlFor="textAreaExample">Address</label>
//                                                 <textarea onChange={(e) => handleChange(e)} value={formData.address} name='address' className="form-control" id="textAreaExample" rows="3"></textarea>
//                                             </div>
...
//                                                 <input onChange={(e) => handleChange(e)} name='no_of_matches' value={formData.no_of_matches} type="text" className="form-control form-control-md"
...
//                                                     <option style={{ color: '#000000' }} selected>Select Category</option>
//                                                     {
//                                                         categories.map((category, index) => {
//                                                             return <option style={{ color: '#000000' }} key={index} value={category.category_id}>{category.type}</option>
//                                                         })
//                                                     }
//                                                 </select>
//                                             </div>
...
//                                                 <select className="form-select" value={formData.sub_category} name='sub_category' aria-label="Default select example">
//                                                     <option style={{ color: '#000000' }} selected>Select Sub-Category</option>
//                                                     {
//                                                         subCategory.map((subCategory, index) => {
//                                                             return <option style={{ color: '#000000' }} key={index} value={subCategory.subCategory_id}>{subCategory.type}</option>
//                                                         })
//                                                     }
//                                                 </select>
//                                             </div>
...
//                                                 <textarea onChange={(e) => handleChange(e)} value={formData.description} name='description' className="form-control" id="textAreaExample" rows="3"></textarea>
//                                             </div>
//                                             <button className="btn btn-outline-primary mt-3 me-2" onClick={prevStep}>Previous</button>
...
export default function SignUpForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        const updatedFormData = profile ?
            { ...formData, first_name: profile.given_name, last_name: profile.family_name, image: profile.picture }
            :
                                            ...
                                            <div className="form-outline">
                                                ...
                                                <select className="form-select" onChange={(e) => {
                                                    ...
                                                    {categories.map((category) => (
                                                        <option style={{ color: '#000000' }} key={category.category_id} value={category.category_id}>{category.type}</option>
                                                    ))}
                                                </select>
                                            </div>
                                            <div className="form-outline">
                                                <label className="form-label">Sub-Category</label>
                                                <select className="form-select" value={formData.subCategory_id} onClick={(e) => handleChange(e)} name='sub_category' aria-label="Default select example">
                                                    <option style={{ color: '#000000' }} value="" disabled>Select Sub-Category</option>
                                                    {
                                                        subCategory.map((subCategory) => (
                                                            <option style={{ color: '#000000' }} key={subCategory.subCategory_id} value={subCategory.subCategory_id}>{subCategory.type}</option>
                                                        ))
                                                    }
                                                </select>
                                            </div>

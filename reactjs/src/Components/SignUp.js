                                    ...
                                    {currentPage === 2 && (
                                        <div className='mt-4'>
                                            <div className="form-outline">
                                                ...
                                                <input onChange={(e) => handleChange(e.target.name, e.target.value)} value={(profile && profile.given_name) || formData.first_name} name='first_name' type="text" className="form-control form-control-md"
                                                    placeholder="Enter your first name" />
                                            </div>
                                            <div className="form-outline mt-2">
                                                <label className="form-label">Last Name</label>
                                                <input onChange={(e) => handleChange(e.target.name, e.target.value)} value={(profile && profile.family_name) || formData.last_name} name='last_name' type="text" className="form-control form-control-md"
                                                    placeholder="Enter your last name" />
                                            </div>
                                            <div className="form-outline">
                                                <label className="form-label">Age</label>
                                                <input onChange={(e) => handleChange(e.target.name, e.target.value)} value={formData.age} name='age' type="text" className="form-control form-control-md"
                                                    placeholder="Enter your age" />
                                            </div>
                                            <div className="form-outline">
                                                <label className="form-label">Gender</label>
                                                <select className="form-select" value={formData.gender} onChange={(e) => handleChange(e.target.name, e.target.value)} name='gender' aria-label="Default select example">
                                            ...
                                            <div className="form-outline mt-2">
                                                ...
                                                <input type="text" onChange={(e) => handleChange(e.target.name, e.target.value)} value={formData.mobile} name='mobile' className="form-control form-control-md"
                                    ...
                                    {currentPage === 3 && (
                                        <div className='mt-4'>
                                            <div className="form-outline">
                                                ...
                                                <input onChange={(e) => handleChange(e.target.name, e.target.value)} value={formData.height} name='height' type="number" className="form-control form-control-md"
                                                    placeholder="Enter your height" />
                                            </div>
                                            <div className="form-outline" data-mdb-input-init>
                                                <label className="form-label" htmlFor="textAreaExample">Address</label>
                                                <textarea onChange={(e) => handleChange(e.target.name, e.target.value)} value={formData.address} name='address' className="form-control" id="textAreaExample" rows="3"></textarea>
                                            </div>
                                    ...
                                    {currentPage === 4 && (
                                        <div className='mt-4'>
                                            <div className="form-outline mt-2">
                                                ...
                                                <input onChange={(e) => handleChange(e.target.name, e.target.value)} name='no_of_matches' value={formData.no_of_matches} type="text" className="form-control form-control-md"
                                            ...
                                            <div className="form-outline">
                                                ...
                                                <select className="form-select" value={formData.subCategory_id} onClick={(e) => handleChange(e.target.name, e.target.value)} name='subCategory_id' aria-label="Default select example">
                                            ...
                                            <div className="form-outline" data-mdb-input-init>
                                                ...
                                                <textarea onChange={(e) => handleChange(e.target.name, e.target.value)} value={formData.description} name='description' className="form-control" id="textAreaExample" rows="3"></textarea>
                                            </div>
                                            <button className="btn btn-outline-primary mt-3 me-2" onClick={prevStep}>Previous</button>
